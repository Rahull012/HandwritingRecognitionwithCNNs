...
#from medicine_name_crop_img_name import prediction_on_user_input3
...
def main1():
    ...
    if args.mode in ['train', 'validate']:
        ...
        print("paths os word segmented and saved are :",grades)
        for xyz in grades:
               print("complete image path ",xyz)

               #try: 
                      #resullt_word_pred1=helpercode(xyz)
                      #print("input image path is as fallow",xyz)
                      #from medicine_name_crop_img_name import prediction_on_user_input3
                      #resullt_word_pred13=prediction_on_user_input3(xyz)
    ...
    #return finall_data_converted_to_text_from_image
